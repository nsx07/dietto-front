  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        className,
        {
          "data-[state=active]:bg-background data-[state=active]:text-foreground": !props.disabled,
          "data-[state=active]:bg-muted data-[state=active]:text-muted-foreground": props.disabled,
